(function() {
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if ((key in storeArgs)) {
        result = storeArgs[key];
      }
      else {
        result = func.apply(this, arguments);
        storeArgs[key] = arguments;
      }
      return result;
    }
  };
  ...
  _.delay = function(func, wait) {
    ...
    setInterval(theFunction, wait);
    function theFunction() {
      func.apply(this, newArray);
    };
  };
  ...
  _.shuffle = function(array) {
    ...
    for (var i = 0; i < newArray.length; i++) {
      ...
      var temp = newArray[i];
      if ((newArray[newIndex] != array[i]) && (newArray[i] != array[newIndex])) {
        newArray[i] = newArray[newIndex];
        newArray[newIndex] = temp;
      }
      if ((newArray[0] == array[0]) && (newArray[newIndex] == array[newIndex])) {
        newArray[0] = array[newIndex];
  ...
  _.invoke = function(collection, functionOrKey, args) {
    ...
    _.each(collection, function(element) {
      if (typeof functionOrKey === "function")
        newArray.push(functionOrKey.apply(element));
      else 
        newArray.push(element[functionOrKey].apply(element));
    });
    return newArray;
  };
